  ...
  --prompt or -p).                                                                                                 
      ...
      parser = argparse.ArgumentParser(description="Process prompts using the Manus agent.")                       
      ...
      try:                                                                                                         
          ...
          asyncio.run(agent.run(prompt))  # Run the agent's run method within an asyncio event loop.               
